...
class _AppointmentFormState extends State<AppointmentForm> {
  ...
  void initState() {
    super.initState();
    _dateTime = widget.existing?.date ?? DateTime.now();
                  ...
                  child: FilledButton(
                    onPressed: () {
                      ...
                      widget.onSave(AppointmentNote(
                        ...
                        calendarEventId: widget.existing?.calendarEventId, // Preserve existing if any
                      ));
                    },
...
class AppointmentsScreen extends ConsumerWidget {
              ...
              return Dismissible(
                ...
                child: Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '$dateStr at $timeStr${a.notes.isNotEmpty ? '\n${a.notes}' : ''}',
                    ),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
  ...
  static void _showAppointmentForm(BuildContext context, WidgetRef ref,
